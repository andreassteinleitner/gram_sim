...
%% Bus-Definitions
    ...
    % Simple Bus Example with standard elements.
    Bus_Example_Simple={...
        {'ExampleSimple', '', 'Description: Simple Example Bus', {...
            {'example_scalar', 1,     'int8',    'real', 'Sample', 'Fixed', [], [], '', 'Description: scalar variable of type int8 with dimension 1'},... 
            {'example_vector', 3,     'single',  'real', 'Sample', 'Fixed', [], [], '', 'Description: vector of type single with dimension 3'},...
            {'example_matrix', [3,3], 'double',  'real', 'Sample', 'Fixed', [], [], '', 'Description: matrix of type double with dimension 3x3'},...
        }}
    };
