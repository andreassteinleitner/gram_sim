...
%% Bus-Definitions
    ...
    ifr_imu={...
        {'ifr_imu', '', 'Description: inertial measurements', {...
            {'time', 1, 'single', 'real', 'Sample', 'Fixed', [], [], '', ''},...
            {'rate', 3, 'single', 'real', 'Sample', 'Fixed', [], [], '', ''},...
            {'acceleration', 3, 'single', 'real', 'Sample', 'Fixed', [], [], '', ''}...
        }}
    };
    
    ifr_opticalFlow={...
        {'ifr_opticalFlow', '', 'Description: optical flow data', {...
            {'isValid', 1, 'boolean', 'real', 'Sample', 'Fixed', [], [], '', ''},...
            {'losRate', 2, 'single', 'real', 'Sample', 'Fixed', [], [], '', ''}...
        }}
    };

    ifr_sonar={...
        {'ifr_sonar', '', 'Description: sonar distance', {...
            {'isValid', 1, 'boolean', 'real', 'Sample', 'Fixed', [], [], '', ''},...
            {'distance', 1, 'single', 'real', 'Sample', 'Fixed', [], [], '', ''}...
        }}
    };

    ifr_lidar={...
        {'ifr_lidar', '', 'Description: lidar distance', {...
            {'isValid', 1, 'boolean', 'real', 'Sample', 'Fixed', [], [], '', ''},...
            {'distance', 1, 'single', 'real', 'Sample', 'Fixed', [], [], '', ''}...
        }}
    };
    ...
    ifr_smLidar={...
        {'ifr_smLidar', '', 'Description: lidar parameters', {...
            {'valid'  , 1, 'boolean', 'real', 'Sample', 'Fixed', [], [], '', ''},...
            {'enabled'  , 1, 'single', 'real', 'Sample', 'Fixed', [], [], '', ''},...
        }}
    };

    ifr_gps={...
        {'ifr_gps', '', 'Description: gps measurements', {...
            {'isValid', 1, 'boolean', 'real', 'Sample', 'Fixed', [], [], '', ''},...
            {'position', 3, 'single', 'real', 'Sample', 'Fixed', [], [], '', ''},...
            {'velocity', 3, 'single', 'real', 'Sample', 'Fixed', [], [], '', ''}...
        }}
    };

    ifr_geodeticReference={...
        {'ifr_geodeticReference', '', 'Description: geodetic reference data', {...
            {'earthMagneticField', 3, 'single', 'real', 'Sample', 'Fixed', [], [], '', ''},...
            {'gravity', 3, 'single', 'real', 'Sample', 'Fixed', [], [], '', ''},...
            {'refLlhRawToNed', 3, 'single', 'real', 'Sample', 'Fixed', [], [], '', ''},...
            {'refPosLlhRaw', 3, 'int32', 'real', 'Sample', 'Fixed', [], [], '', ''}...
            {'refPosValid', 1, 'boolean', 'real', 'Sample', 'Fixed', [], [], '', ''}...
        }}
    };

    ifr_baro={...
        {'ifr_baro', '', 'Description: barometric height', {...
            {'isValid', 1, 'boolean', 'real', 'Sample', 'Fixed', [], [], '', ''},...
            {'height', 1, 'single', 'real', 'Sample', 'Fixed', [], [], '', ''}...
        }}
    };

    ifr_mag={...
        {'ifr_mag', '', 'Description: magnetometer measurement', {...
            {'isValid', 1, 'boolean', 'real', 'Sample', 'Fixed', [], [], '', ''},...
            {'magneticField', 3, 'single', 'real', 'Sample', 'Fixed', [], [], '', ''}...
        }}
    };

    % Cell Array with all Bus definition
    Bus_Definitions = {ifr_imu,ifr_opticalFlow,ifr_sonar,ifr_lidar,ifr_smLidar,ifr_gps,ifr_geodeticReference,ifr_baro,ifr_mag};
